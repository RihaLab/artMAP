...
const wizardFaceDataInputFastQ = ({ handleSubmit, valid, submitting }) => {
  const onSubmit = (e) => {
    e.preventDefault();
    handleSubmit();
  };
...
wizardFaceDataInputFastQ.propTypes = PropTypes.shape(formPropTypes).isRequired;
